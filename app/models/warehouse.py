...
class Warehouse:
    ...
    def get_all():
        ...
        query = """
            ...
            FROM wms_management_system.almacenes
            WHERE activo = 1
            ORDER BY nombre
        """
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM wms_management_system.almacenes WHERE activo = 1"
    ...
    def create(data):
        ...
        query = """
            INSERT INTO wms_management_system.almacenes 
    ...
    def update(warehouse_id, data):
        ...
        query = """
            UPDATE wms_management_system.almacenes 
            SET nombre = %s,
                ubicacion = %s,
                capacidad = %s,
                activo = %s
    ...
    def delete(warehouse_id):
        ...
        query = "UPDATE wms_management_system.almacenes SET activo = 0 WHERE id = %s"

...
class Client:
    ...
    def get_all():
        ...
        query = """
            ...
            FROM wms_management_system.clientes
            WHERE activo = 1
            ORDER BY nombre
        """
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM wms_management_system.clientes WHERE activo = 1"
    ...
    def create(data):
        ...
        query = """
            INSERT INTO wms_management_system.clientes 
    ...
    def update(client_id, data):
        ...
        query = """
            UPDATE wms_management_system.clientes 
            SET nombre = %s,
                documento = %s,
                telefono = %s,
                email = %s,
    ...
    def delete(client_id):
        ...
        query = "UPDATE wms_management_system.clientes SET activo = 0 WHERE id = %s"

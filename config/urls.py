...
urlpatterns = [
    ...
    path(
        "clientes/<int:client_id>/editar/", ClientController.edit, name="clients_edit"
    ),
    path(
        "clientes/<int:client_id>/eliminar/",
    ...
    path(
        "almacenes/<int:warehouse_id>/editar/",
    ...
    path(
        "detalle-ventas/crear/", SaleDetailController.create, name="sale_details_create"
    ),
    path(
    ...
    path(
        "detalle-ventas/<int:detail_id>/ver/",
        SaleDetailController.view,
        name="sale_details_view",
    ),
    path("compras/", PurchaseController.index, name="purchases"),
    path("compras/crear/", PurchaseController.create, name="purchases_create"),
    path(
        "compras/<int:purchase_id>/editar/",
        PurchaseController.edit,
        name="purchases_edit",
    ),
    path(
        "compras/<int:purchase_id>/eliminar/",
        PurchaseController.delete,
        name="purchases_delete",
    ),
    path(
        "compras/<int:purchase_id>/ver/", PurchaseController.view, name="purchases_view"
    ),
    ...
    path(
        ...
        InventoryMovementController.index,
    ...
    path(
        ...
        ConfigController.edit_profile,
        name="config_edit_profile",
    ),
    path(
    ...
    path(
        ...
        ConfigController.create_user,
        name="config_create_user",
    ),
    path(
    ...
    path("chatbot/", ChatbotController.index, name="chatbot_index"),
    # Enviar mensaje (exempt de CSRF para peticiones AJAX)
    path(
        "chatbot/send-message/",
        csrf_exempt(ChatbotController.send_message),
        name="chatbot_send_message",
    ),
    # Obtener insights rápidos
    path(
        "chatbot/get-insights/",
        ChatbotController.get_insights,
        name="chatbot_get_insights",
    ),
    # Obtener sugerencias de preguntas
    path(
        "chatbot/get-suggestions/",
        ChatbotController.get_suggestions,
        name="chatbot_get_suggestions",
    ),
    # Limpiar historial (exempt de CSRF para peticiones AJAX)
    path(
        "chatbot/clear-history/",
        csrf_exempt(ChatbotController.clear_history),
        name="chatbot_clear_history",
    ),
    # Obtener historial
    path(
        "chatbot/get-history/",
        ChatbotController.get_history,
        name="chatbot_get_history",
    ),
]
